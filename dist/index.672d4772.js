...
class App {
    ...
    _newWorkout(e) {
        ...
        if (type === "running") {
            ...
            !validInputs(distance, duration, cadence) || !allPositive(distance, duration, cadence)) return alert("Input have to be positive number!");
            workout = new Running([
                lat,
                lng
    ...
    _setLocalStorage() {
        localStorage.setItem(//Sets the value of the pair identified by key to value, creating a new key/value pair if none existed for key previously.
        "workouts", JSON.stringify(//Converts a JavaScript value to a JavaScript Object Notation (JSON) string.
        this.#workouts));
    }
    _getLocalStorage() {
